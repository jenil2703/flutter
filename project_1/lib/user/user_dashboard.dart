...
import 'package:project_1/user/usercategory.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: Text("${list[index]['category_name']}".toUpperCase(),style: TextStyle(fontStyle: FontStyle.italic,fontSize: 15, color: Colors.black)),
                          ),
                        ),
                      ],
                    ),
