...
class AdminHomePage extends State<AdminHome> {
  ...
  Future<List> viewCategoryData() async {
    final responce = await http.get(Uri.parse(
        "https://jenil2703.000webhostapp.com/API_project_1/category_view.php"));
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text('Admin Dashboard',style: TextStyle(fontWeight: FontWeight.bold),),backgroundColor: Colors.white,
          actions: [
            IconButton(
                onPressed: () {
...
/////////////////////////////////////////////////////////////////////////////////
  ...
  void deleteCategory(var id) {
    var url =
        "https://jenil2703.000webhostapp.com/API_project_1/category_delete.php";
  ...
  void updateCategoryName(var id) {
    var url =
        "https://jenil2703.000webhostapp.com/API_project_1/category_update.php";
    http.post(Uri.parse(url), body: {
      'id': id,
