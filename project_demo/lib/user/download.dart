    ...
    return Scaffold(
      body: FutureBuilder(
        ...
        builder: (context,snapshot){
          return data.length==0 ? fetchingData==true ? Center(child: CircularProgressIndicator()) : Center(child: Column(children: [SizedBox(height: size.height*40/100),Text("Downloaded Images Empty".toUpperCase(),style: TextStyle(color: Colors.black,fontStyle: FontStyle.italic))])) :
