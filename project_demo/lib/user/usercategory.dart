...
class CategoryPage extends State<Category> {
  ...
  Future<List> viewCategoryItemsData() async {
    final responce = await http.get(Uri.parse(
        "https://jenil2703.000webhostapp.com/API_project_1/category_img_view.php?data=${widget.index}"));
...
class ItemsState extends State<Items> {
  ...
  void _save(var url) async {
    ...
    if (status.isGranted) {
      ...
      //db.insertData(Model(url: savePath));
      db.insertData(Model1(url: savePath));
